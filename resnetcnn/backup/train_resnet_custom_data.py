...
# ------------------------------------------- Loading a model ------------------------------------------------
train_data_dir = 'img50/train'
validation_data_dir = 'img50/validation'

num_classes = 10
trainSamplesNum = 500 # number of train images
validationSamplesNum = 100 # number of validation samples
